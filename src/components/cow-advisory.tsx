...
export default function CowAdvisory({ isDay, meshDensity, isRadarBreach, isSbbOptimized }: CowAdvisoryProps) {
    ...
    return (
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-3 shadow-xl flex items-start gap-4 transition-all duration-300 min-h-[70px]">
            {/* Minimalist Cyan Cow Icon (Fixed Typography and Style) */}
            ...
            {/* Message Display - Ensuring strict Monospace Font */}
            <div className="flex flex-col gap-1 overflow-hidden font-mono">
                <div className="flex items-center gap-2">
                    <span className="hud-label !text-cyan-400 !text-[10px] tracking-widest opacity-100 flex items-center gap-1.5 uppercase font-bold">
                        <span className="w-1.5 h-1.5 rounded-full bg-cyan-400 animate-pulse" />
                        ADVISORY_CORE // CH-COW-01.AI
                    </span>
                </div>
                <div className="text-[11px] leading-relaxed text-white/90 min-h-[32px]">
